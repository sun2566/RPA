...
async def generate_qr(data: str = Form(...)):
    ...
    img_byte__arr = BytesIO()
    img.save(img_byte__arr, format='PNG')
    img_byte__arr = img_byte__arr.getvalue()
    
    return StreamingResponse(BytesIO(img_byte__arr), media_type="image/png")
